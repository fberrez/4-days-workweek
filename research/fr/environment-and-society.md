...
<svg viewBox="0 0 680 260" width="100%" xmlns="http://www.w3.org/2000/svg" style="font-family: sans-serif;">
  ...
  <text x="340" y="60" text-anchor="middle" font-size="18" font-weight="bold" fill="#31332e">Potentiel de réduction carbone au Royaume-Uni</text>
  <text x="340" y="120" text-anchor="middle" font-size="56" font-weight="bold" fill="#9a462a">127M tonnes</text>
  <text x="340" y="160" text-anchor="middle" font-size="18" fill="#31332e">de CO&#x2082; par an pourraient être économisées</text>
  <line x1="200" y1="185" x2="480" y2="185" stroke="#e5e7eb" stroke-width="1"/>
  <text x="340" y="215" text-anchor="middle" font-size="16" fill="#46673e">= retirer 27 millions de voitures de la route</text>
...
<svg viewBox="0 0 800 300" width="100%" xmlns="http://www.w3.org/2000/svg" style="font-family: sans-serif;">
  ...
  <text x="400" y="36" text-anchor="middle" font-size="18" font-weight="bold" fill="#31332e">Temps de travail : frise historique</text>
  <!-- Grid line -->
  ...
  <text x="100" y="82" text-anchor="middle" font-size="13" font-weight="bold" fill="#9a462a">~3 000 h/an</text>
  <!-- 1926 -->
  ...
  <text x="270" y="112" text-anchor="middle" font-size="12" fill="#46673e">Ford adopte la</text>
  <text x="270" y="126" text-anchor="middle" font-size="12" fill="#46673e">semaine de 5 jours</text>
  <!-- 1940 -->
  ...
  <text x="440" y="122" text-anchor="middle" font-size="12" fill="#46673e">Norme de</text>
  <text x="440" y="136" text-anchor="middle" font-size="12" fill="#46673e">40 heures</text>
  <!-- Aujourd'hui -->
  <circle cx="580" cy="160" r="7" fill="#9a462a"/>
  <line x1="580" y1="167" x2="580" y2="200" stroke="#e5e7eb" stroke-width="1" stroke-dasharray="4,3"/>
  <text x="580" y="222" text-anchor="middle" font-size="14" font-weight="bold" fill="#31332e">Aujourd'hui</text>
  <text x="580" y="145" text-anchor="middle" font-size="13" font-weight="bold" fill="#9a462a">~1 750 h/an</text>
  <!-- Prochaine étape -->
  ...
  <text x="710" y="222" text-anchor="middle" font-size="14" font-weight="bold" fill="#31332e">Prochaine</text>
  <text x="710" y="126" text-anchor="middle" font-size="12" fill="#46673e">Semaine de</text>
  <text x="710" y="140" text-anchor="middle" font-size="12" fill="#46673e">4 jours ?</text>
  <!-- Arrow at end -->
  <polygon points="745,200 755,196 755,204" fill="#e5e7eb"/>
  <!-- Subtitle -->
  <text x="400" y="268" text-anchor="middle" font-size="13" fill="#31332e" opacity="0.7">200 ans de baisse du temps de travail annuel</text>
</svg>
</div>
